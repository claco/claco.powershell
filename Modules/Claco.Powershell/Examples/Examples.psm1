...
function Invoke-SimpleExample {
    ...
    try {
        ...
        # Write-Host $(Get-Variable ExceptionPreference)
        # Write-Host $(Get-Variable ExceptionPreference -Scope Local)
        # Write-Host $(Get-Variable ExceptionPreference -Scope Script)
        # Write-Host $(Get-Variable ExceptionPreference -Scope Global)

        Write-Deug "ConfirmPreference=$ConfirmPreference"
        ...
        Write-Host Get-Variable ExceptionActionPreference
        Write-Exception
    } finally {
